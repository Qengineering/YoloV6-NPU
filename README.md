# YoloV6 NPU
![output image]( https://qengineering.eu/github/YoloV6_Parking_NPU.webp )
## YoloV6 for RK3566/68/88 NPU (Rock 5, Orange Pi 5, Radxa Zero 3). <br/>
...
$ mkdir *MyDir* <br/>
$ cd *MyDir* <br/>
$ git clone https://github.com/Qengineering/YoloV6-NPU.git <br/>
```
...
![output image]( https://qengineering.eu/github/YoloV6_Bus_NPU.webp )
